...
This module contains all constant values used throughout the ETL system.
...
class ETLConstants:
    """Central constants class for ETL system configuration and business rules"""
...
MESSAGES = ETLConstants.Messages