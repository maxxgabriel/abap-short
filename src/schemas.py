...
Defines StructType schemas for all data structures used in ETL process.
"""
...
class ETLSchemas:
    ...
    def raw_sales_schema() -> StructType:
        ...
        Migrated from ABAP ty_raw_sales structure
        """
        return StructType([
    ...
    def analytics_schema() -> StructType:
        ...
        Migrated from ABAP ty_analytics structure
        """
        return StructType([
    ...
    def etl_log_schema() -> StructType:
        ...
        Migrated from ABAP ty_etl_log structure
        """
        return StructType([
